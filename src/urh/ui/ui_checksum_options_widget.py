...
class Ui_ChecksumOptions(object):
    def setupUi(self, ChecksumOptions):
        ...
        self.scrollArea = QtWidgets.QScrollArea(parent=ChecksumOptions)
        ...
        self.comboBoxCategory = QtWidgets.QComboBox(parent=self.scrollAreaWidgetContents)
        ...
        self.lineEditFinalXOR = QtWidgets.QLineEdit(parent=self.page_crc)
        self.lineEditFinalXOR.setObjectName("lineEditFinalXOR")
        self.gridLayout_2.addWidget(self.lineEditFinalXOR, 3, 1, 1, 1)
        self.label_5 = QtWidgets.QLabel(parent=self.page_crc)
        self.label_5.setObjectName("label_5")
        self.gridLayout_2.addWidget(self.label_5, 1, 0, 1, 1)
        self.groupBox = QtWidgets.QGroupBox(parent=self.page_crc)
        self.groupBox.setObjectName("groupBox")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.groupBox)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.tableViewDataRanges = QtWidgets.QTableView(parent=self.groupBox)
        ...
        self.btnAddRange = QtWidgets.QToolButton(parent=self.groupBox)
        ...
        self.btnRemoveRange = QtWidgets.QToolButton(parent=self.groupBox)
        ...
        self.lineEditStartValue = QtWidgets.QLineEdit(parent=self.page_crc)
        self.lineEditStartValue.setObjectName("lineEditStartValue")
        self.gridLayout_2.addWidget(self.lineEditStartValue, 2, 1, 1, 1)
        self.label_3 = QtWidgets.QLabel(parent=self.page_crc)
        self.label_3.setObjectName("label_3")
        self.gridLayout_2.addWidget(self.label_3, 0, 0, 1, 1)
        self.label_2 = QtWidgets.QLabel(parent=self.page_crc)
        self.label_2.setObjectName("label_2")
        self.gridLayout_2.addWidget(self.label_2, 3, 0, 1, 1)
        self.label = QtWidgets.QLabel(parent=self.page_crc)
        self.label.setObjectName("label")
        self.gridLayout_2.addWidget(self.label, 2, 0, 1, 1)
        self.lineEditCRCPolynomial = QtWidgets.QLineEdit(parent=self.page_crc)
        ...
        self.comboBoxCRCFunction = QtWidgets.QComboBox(parent=self.page_crc)
        self.comboBoxCRCFunction.setObjectName("comboBoxCRCFunction")
        self.gridLayout_2.addWidget(self.comboBoxCRCFunction, 0, 1, 1, 1)
        self.label_crc_info = QtWidgets.QLabel(parent=self.page_crc)
        ...
        self.checkBoxRefIn = QtWidgets.QCheckBox(parent=self.page_crc)
        self.checkBoxRefIn.setObjectName("checkBoxRefIn")
        self.gridLayout_2.addWidget(self.checkBoxRefIn, 4, 0, 1, 2)
        self.checkBoxRefOut = QtWidgets.QCheckBox(parent=self.page_crc)
        ...
        self.radioButtonWSPChecksum8 = QtWidgets.QRadioButton(parent=self.page_wsp)
        ...
        self.radioButtonWSPCRC8 = QtWidgets.QRadioButton(parent=self.page_wsp)
        ...
        spacerItem2 = QtWidgets.QSpacerItem(20, 107, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
