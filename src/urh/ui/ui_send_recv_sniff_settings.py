...
class Ui_SniffSettings(object):
    def setupUi(self, SniffSettings):
        ...
        self.groupBoxSniffSettings = QtWidgets.QGroupBox(parent=SniffSettings)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        self.label_sniff_Center = QtWidgets.QLabel(parent=self.frame)
        ...
        self.spinbox_sniff_Noise = QtWidgets.QDoubleSpinBox(parent=self.frame)
        ...
        self.checkBoxAdaptiveNoise = QtWidgets.QCheckBox(parent=self.frame)
        ...
        self.label_sniff_Modulation = QtWidgets.QLabel(parent=self.frame)
        ...
        self.label_sniff_Signal = QtWidgets.QLabel(parent=self.frame)
        self.label_sniff_Signal.setObjectName("label_sniff_Signal")
        self.gridLayout.addWidget(self.label_sniff_Signal, 0, 0, 1, 1)
        self.spinbox_sniff_ErrorTolerance = QtWidgets.QSpinBox(parent=self.frame)
        ...
        self.combox_sniff_Modulation = QtWidgets.QComboBox(parent=self.frame)
        ...
        self.label_sniff_Tolerance = QtWidgets.QLabel(parent=self.frame)
        ...
        self.spinbox_sniff_SamplesPerSymbol = QtWidgets.QSpinBox(parent=self.frame)
        ...
        self.label_sniff_viewtype = QtWidgets.QLabel(parent=self.frame)
        self.label_sniff_viewtype.setObjectName("label_sniff_viewtype")
        self.gridLayout.addWidget(self.label_sniff_viewtype, 9, 0, 1, 1)
        self.lineEdit_sniff_OutputFile = QtWidgets.QLineEdit(parent=self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_sniff_BitLength = QtWidgets.QLabel(parent=self.frame)
        ...
        self.spinBoxCenterSpacing = QtWidgets.QDoubleSpinBox(parent=self.frame)
        ...
        self.comboBox_sniff_signal = QtWidgets.QComboBox(parent=self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btn_sniff_use_signal = QtWidgets.QPushButton(parent=self.frame)
        ...
        self.label_sniff_OutputFile = QtWidgets.QLabel(parent=self.frame)
        ...
        self.spinbox_sniff_Center = QtWidgets.QDoubleSpinBox(parent=self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.checkBoxAutoCenter = QtWidgets.QCheckBox(parent=self.frame)
        ...
        self.label_sniff_encoding = QtWidgets.QLabel(parent=self.frame)
        ...
        self.comboBox_sniff_viewtype = QtWidgets.QComboBox(parent=self.frame)
        ...
        self.checkBox_sniff_Timestamp = QtWidgets.QCheckBox(parent=self.frame)
        ...
        self.label_sniff_Noise = QtWidgets.QLabel(parent=self.frame)
        self.label_sniff_Noise.setObjectName("label_sniff_Noise")
        self.gridLayout.addWidget(self.label_sniff_Noise, 1, 0, 1, 1)
        self.comboBox_sniff_encoding = QtWidgets.QComboBox(parent=self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.labelCenterSpacing = QtWidgets.QLabel(parent=self.frame)
        ...
        self.spinBoxBitsPerSymbol = QtWidgets.QSpinBox(parent=self.frame)
    ...
    def retranslateUi(self, SniffSettings):
        ...
        self.checkBoxAdaptiveNoise.setToolTip(_translate("SniffSettings", "<html><head/><body><p>With adaptive noise the app will update the noise level automatically during RX. This is helpful in a dynamic environment where noise differs in time.</p></body></html>"))
