...
class Ui_DialogCSVImport(object):
    def setupUi(self, DialogCSVImport):
        ...
        self.labelFileNotFound = QtWidgets.QLabel(parent=DialogCSVImport)
        ...
        self.comboBoxCSVSeparator = QtWidgets.QComboBox(parent=DialogCSVImport)
        ...
        self.btnAddSeparator = QtWidgets.QToolButton(parent=DialogCSVImport)
        ...
        self.spinBoxTimestampColumn = QtWidgets.QSpinBox(parent=DialogCSVImport)
        ...
        self.label = QtWidgets.QLabel(parent=DialogCSVImport)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 4, 0, 1, 2)
        self.spinBoxQDataColumn = QtWidgets.QSpinBox(parent=DialogCSVImport)
        ...
        self.label_3 = QtWidgets.QLabel(parent=DialogCSVImport)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 6, 0, 1, 2)
        self.label_2 = QtWidgets.QLabel(parent=DialogCSVImport)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 5, 0, 1, 2)
        self.groupBox = QtWidgets.QGroupBox(parent=DialogCSVImport)
        self.groupBox.setObjectName("groupBox")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.groupBox)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.tableWidgetPreview = QtWidgets.QTableWidget(parent=self.groupBox)
        ...
        self.lineEditFilename = QtWidgets.QLineEdit(parent=DialogCSVImport)
        self.lineEditFilename.setObjectName("lineEditFilename")
        self.horizontalLayout_2.addWidget(self.lineEditFilename)
        self.btnChooseFile = QtWidgets.QToolButton(parent=DialogCSVImport)
        self.btnChooseFile.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextOnly)
        ...
        self.spinBoxIDataColumn = QtWidgets.QSpinBox(parent=DialogCSVImport)
        ...
        self.label_4 = QtWidgets.QLabel(parent=DialogCSVImport)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 3, 0, 1, 2)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=DialogCSVImport)
        self.buttonBox.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Cancel|QtWidgets.QDialogButtonBox.StandardButton.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.gridLayout.addWidget(self.buttonBox, 9, 2, 1, 1)
        self.groupBoxFilePreview = QtWidgets.QGroupBox(parent=DialogCSVImport)
        ...
        self.plainTextEditFilePreview = QtWidgets.QPlainTextEdit(parent=self.groupBoxFilePreview)
        ...
        self.label_5 = QtWidgets.QLabel(parent=DialogCSVImport)
        self.label_5.setObjectName("label_5")
        self.gridLayout.addWidget(self.label_5, 0, 0, 1, 1)
        self.btnAutoDefault = QtWidgets.QPushButton(parent=DialogCSVImport)
        ...
        self.buttonBox.accepted.connect(DialogCSVImport.accept) # type: ignore
        self.buttonBox.rejected.connect(DialogCSVImport.reject) # type: ignore
    ...
    def retranslateUi(self, DialogCSVImport):
        ...
        self.labelFileNotFound.setText(_translate("DialogCSVImport", "<html><head/><body><p><span style=\" color:#f87171;\">Could not open the selected file.</span></p></body></html>"))
        ...
        self.spinBoxTimestampColumn.setToolTip(_translate("DialogCSVImport", "<html><head/><body><p> If your dataset contains timestamps the app will calculate the sample rate from them. You can manually edit the sample rate after import in the signal details.</p></body></html>"))
        ...
        self.label_3.setToolTip(_translate("DialogCSVImport", "<html><head/><body><p> If your dataset contains timestamps the app will calculate the sample rate from them. You can manually edit the sample rate after import in the signal details.</p></body></html>"))
