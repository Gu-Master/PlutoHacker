...
class Ui_DialogAdvancedModSettings(object):
    def setupUi(self, DialogAdvancedModSettings):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=DialogAdvancedModSettings)
        ...
        self.spinBoxPauseThreshold = QtWidgets.QSpinBox(parent=self.groupBox)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(parent=DialogAdvancedModSettings)
        ...
        self.spinBoxMessageLengthDivisor = QtWidgets.QSpinBox(parent=self.groupBox_2)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=DialogAdvancedModSettings)
        ...
        self.buttonBox.accepted.connect(DialogAdvancedModSettings.accept) # type: ignore
        self.buttonBox.rejected.connect(DialogAdvancedModSettings.reject) # type: ignore
    ...
    def retranslateUi(self, DialogAdvancedModSettings):
        ...
        self.label_2.setText(_translate("DialogAdvancedModSettings", "<html><head/><body><p>With the message <span style=\" font-weight:600;\">divisor length</span> you can control the minimum message length in a flexible way. the app will try to demodulate signals in such a way, that the resulting message has a number of bits that is divisble by the configured divisor. <br/><br/><span style=\" font-style:italic;\">How does the zero padding work? Remaining zero bits are taken from the pause behind the message if possible.</span></p></body></html>"))
