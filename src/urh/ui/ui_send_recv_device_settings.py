...
class Ui_FormDeviceSettings(object):
    def setupUi(self, FormDeviceSettings):
        ...
        self.groupBoxDeviceSettings = QtWidgets.QGroupBox(parent=FormDeviceSettings)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        self.frame_2 = QtWidgets.QFrame(parent=self.groupBoxDeviceSettings)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.labelSubdevice = QtWidgets.QLabel(parent=self.frame_2)
        self.labelSubdevice.setObjectName("labelSubdevice")
        self.gridLayout.addWidget(self.labelSubdevice, 2, 0, 1, 1)
        self.spinBoxFreq = KillerDoubleSpinBox(parent=self.frame_2)
        ...
        self.lineEditIP = QtWidgets.QLineEdit(parent=self.frame_2)
        self.lineEditIP.setObjectName("lineEditIP")
        self.gridLayout.addWidget(self.lineEditIP, 5, 1, 1, 1)
        self.btnRefreshDeviceIdentifier = QtWidgets.QToolButton(parent=self.frame_2)
        ...
        self.labelDirectSampling = QtWidgets.QLabel(parent=self.frame_2)
        self.labelDirectSampling.setObjectName("labelDirectSampling")
        self.gridLayout.addWidget(self.labelDirectSampling, 15, 0, 1, 1)
        self.labelBandwidth = QtWidgets.QLabel(parent=self.frame_2)
        ...
        self.sliderGain = QtWidgets.QSlider(parent=self.frame_2)
        self.sliderGain.setMaximum(100)
        self.sliderGain.setSingleStep(1)
        self.sliderGain.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.sliderGain.setObjectName("sliderGain")
        self.gridLayout_5.addWidget(self.sliderGain, 0, 0, 1, 1)
        self.spinBoxGain = QtWidgets.QSpinBox(parent=self.frame_2)
        ...
        self.labelSampleRate = QtWidgets.QLabel(parent=self.frame_2)
        self.labelSampleRate.setObjectName("labelSampleRate")
        self.gridLayout.addWidget(self.labelSampleRate, 8, 0, 1, 1)
        self.gridLayout_7 = QtWidgets.QGridLayout()
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.sliderIFGain = QtWidgets.QSlider(parent=self.frame_2)
        self.sliderIFGain.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.sliderIFGain.setObjectName("sliderIFGain")
        self.gridLayout_7.addWidget(self.sliderIFGain, 0, 0, 1, 1)
        self.spinBoxIFGain = QtWidgets.QSpinBox(parent=self.frame_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.labelFreqCorrection = QtWidgets.QLabel(parent=self.frame_2)
        self.labelFreqCorrection.setObjectName("labelFreqCorrection")
        self.gridLayout.addWidget(self.labelFreqCorrection, 13, 0, 1, 1)
        self.comboBoxDeviceIdentifier = QtWidgets.QComboBox(parent=self.frame_2)
        self.comboBoxDeviceIdentifier.setEditable(True)
        self.comboBoxDeviceIdentifier.setInsertPolicy(QtWidgets.QComboBox.InsertPolicy.NoInsert)
        ...
        self.cbDevice = QtWidgets.QComboBox(parent=self.frame_2)
        ...
        self.spinBoxNRepeat = QtWidgets.QSpinBox(parent=self.frame_2)
        ...
        self.sliderBasebandGain = QtWidgets.QSlider(parent=self.frame_2)
        self.sliderBasebandGain.setSliderPosition(0)
        self.sliderBasebandGain.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.sliderBasebandGain.setInvertedAppearance(False)
        self.sliderBasebandGain.setInvertedControls(False)
        self.sliderBasebandGain.setTickPosition(QtWidgets.QSlider.TickPosition.NoTicks)
        ...
        self.spinBoxBasebandGain = QtWidgets.QSpinBox(parent=self.frame_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.labelPort = QtWidgets.QLabel(parent=self.frame_2)
        self.labelPort.setObjectName("labelPort")
        self.gridLayout.addWidget(self.labelPort, 6, 0, 1, 1)
        self.spinBoxSampleRate = KillerDoubleSpinBox(parent=self.frame_2)
        ...
        self.labelGain = QtWidgets.QLabel(parent=self.frame_2)
        self.labelGain.setObjectName("labelGain")
        self.gridLayout.addWidget(self.labelGain, 10, 0, 1, 1)
        self.checkBoxDCCorrection = QtWidgets.QCheckBox(parent=self.frame_2)
        ...
        self.labelDeviceIdentifier = QtWidgets.QLabel(parent=self.frame_2)
        ...
        self.labelIP = QtWidgets.QLabel(parent=self.frame_2)
        self.labelIP.setObjectName("labelIP")
        self.gridLayout.addWidget(self.labelIP, 5, 0, 1, 1)
        self.spinBoxFreqCorrection = QtWidgets.QSpinBox(parent=self.frame_2)
        ...
        self.labelNRepeat = QtWidgets.QLabel(parent=self.frame_2)
        self.labelNRepeat.setObjectName("labelNRepeat")
        self.gridLayout.addWidget(self.labelNRepeat, 16, 0, 1, 1)
        self.comboBoxDirectSampling = QtWidgets.QComboBox(parent=self.frame_2)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/lock.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.labelBiasTee = QtWidgets.QLabel(parent=self.frame_2)
        self.labelBiasTee.setObjectName("labelBiasTee")
        self.gridLayout.addWidget(self.labelBiasTee, 14, 0, 1, 1)
        self.checkBoxBiasTee = QtWidgets.QCheckBox(parent=self.frame_2)
        ...
        self.groupBoxDeviceSettings.toggled['bool'].connect(self.frame_2.setVisible) # type: ignore
    ...
    def retranslateUi(self, FormDeviceSettings):
        ...
        self.lineEditSubdevice.setToolTip(_translate("FormDeviceSettings", "<html><head/><body><p>PlutoSDR selection is handled via the device identifier list when multiple devices are available.</p></body></html>"))
        self.labelSubdevice.setToolTip(_translate("FormDeviceSettings", "<html><head/><body><p>PlutoSDR selection is handled via the device identifier list when multiple devices are available.</p></body></html>"))
        ...
        self.comboBoxDeviceIdentifier.setToolTip(_translate("FormDeviceSettings", "<html><head/><body><p>You can enter a device identifier here if you have multiple SDRs of the same type attached to separate them. There is no need to configure this value otherwise. the app will <span style=\" font-weight:600;\">automatically</span> select an attached SDR of the configured type if you leave this value empty.</p></body></html>"))
        self.cbDevice.setItemText(0, _translate("FormDeviceSettings", "PlutoSDR"))
