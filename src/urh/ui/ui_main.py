...
"}")
        ...
        self.verticalLayout_waterfall = QtWidgets.QVBoxLayout(self.tab_waterfall)
        self.verticalLayout_waterfall.setContentsMargins(14, 14, 14, 14)
        self.verticalLayout_waterfall.setSpacing(12)
        self.verticalLayout_waterfall.setObjectName("verticalLayout_waterfall")
        self.horizontalLayoutWaterfallHeader = QtWidgets.QHBoxLayout()
        self.horizontalLayoutWaterfallHeader.setSpacing(12)
        self.horizontalLayoutWaterfallHeader.setObjectName("horizontalLayoutWaterfallHeader")
        self.labelWaterfallHint = QtWidgets.QLabel(parent=self.tab_waterfall)
        self.labelWaterfallHint.setWordWrap(True)
        self.labelWaterfallHint.setStyleSheet("font-size: 13px; color: rgba(226, 232, 240, 0.78);")
        self.labelWaterfallHint.setObjectName("labelWaterfallHint")
        self.horizontalLayoutWaterfallHeader.addWidget(self.labelWaterfallHint)
        self.btnRecordFromWaterfall = QtWidgets.QPushButton(parent=self.tab_waterfall)
        self.btnRecordFromWaterfall.setMinimumSize(QtCore.QSize(190, 40))
        self.btnRecordFromWaterfall.setStyleSheet("QPushButton#btnRecordFromWaterfall {\n"
"    border-radius: 10px;\n"
"    font-size: 14px;\n"
"    font-weight: 600;\n"
"    padding: 8px 12px;\n"
...
"}")
        self.btnRecordFromWaterfall.setObjectName("btnRecordFromWaterfall")
        self.horizontalLayoutWaterfallHeader.addWidget(self.btnRecordFromWaterfall)
        self.verticalLayout_waterfall.addLayout(self.horizontalLayoutWaterfallHeader)
        self.frameWaterfallHost = QtWidgets.QFrame(parent=self.tab_waterfall)
        self.frameWaterfallHost.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frameWaterfallHost.setStyleSheet("QFrame#frameWaterfallHost {\n"
"    border: 1px solid rgba(56, 189, 248, 0.22);\n"
"    border-radius: 14px;\n"
"}")
        self.frameWaterfallHost.setObjectName("frameWaterfallHost")
        self.verticalLayoutWaterfallHost = QtWidgets.QVBoxLayout(self.frameWaterfallHost)
        self.verticalLayoutWaterfallHost.setContentsMargins(0, 0, 0, 0)
        self.verticalLayoutWaterfallHost.setObjectName("verticalLayoutWaterfallHost")
        self.waterfallContainer = QtWidgets.QWidget(parent=self.frameWaterfallHost)
        self.waterfallContainer.setObjectName("waterfallContainer")
        self.verticalLayoutWaterfallHost.addWidget(self.waterfallContainer)
        self.verticalLayout_waterfall.addWidget(self.frameWaterfallHost)
        self.tabWidget.addTab(self.tab_waterfall, "")
        self.tab_repeat = QtWidgets.QWidget()
        self.tab_repeat.setObjectName("tab_repeat")
        self.verticalLayout_repeat = QtWidgets.QVBoxLayout(self.tab_repeat)
        self.verticalLayout_repeat.setContentsMargins(14, 14, 14, 14)
        self.verticalLayout_repeat.setObjectName("verticalLayout_repeat")
        self.splitterRepeat = QtWidgets.QSplitter(parent=self.tab_repeat)
        self.splitterRepeat.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.splitterRepeat.setHandleWidth(6)
        self.splitterRepeat.setObjectName("splitterRepeat")
        self.frameRepeatSidebar = QtWidgets.QFrame(parent=self.splitterRepeat)
        self.frameRepeatSidebar.setMinimumSize(QtCore.QSize(250, 0))
        self.frameRepeatSidebar.setMaximumSize(QtCore.QSize(360, 16777215))
        self.frameRepeatSidebar.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frameRepeatSidebar.setStyleSheet("QFrame#frameRepeatSidebar {\n"
"    background: rgba(18, 24, 38, 0.94);\n"
"    border-right: 1px solid rgba(230, 168, 72, 0.20);\n"
"}\n"
"QListWidget#listWidgetReplaySignals {\n"
"    border: 1px solid rgba(148, 163, 184, 0.22);\n"
"    border-radius: 12px;\n"
"    padding: 6px;\n"
"    outline: none;\n"
"}\n"
"QListWidget#listWidgetReplaySignals::item {\n"
"    min-height: 32px;\n"
"    border-radius: 8px;\n"
"    padding: 6px 8px;\n"
"}\n"
"QListWidget#listWidgetReplaySignals::item:selected {\n"
"    background: rgba(230, 168, 72, 0.20);\n"
"}\n"
"QPushButton#btnOpenSignalForReplay, QPushButton#btnChooseReplayFolder {\n"
"    min-height: 42px;\n"
"    border-radius: 10px;\n"
"    font-size: 14px;\n"
"    font-weight: 600;\n"
...
"}")
        self.frameRepeatSidebar.setObjectName("frameRepeatSidebar")
        self.verticalLayoutRepeatSidebar = QtWidgets.QVBoxLayout(self.frameRepeatSidebar)
        self.verticalLayoutRepeatSidebar.setContentsMargins(18, 18, 18, 18)
        self.verticalLayoutRepeatSidebar.setSpacing(14)
        self.verticalLayoutRepeatSidebar.setObjectName("verticalLayoutRepeatSidebar")
        self.labelRepeatTitle = QtWidgets.QLabel(parent=self.frameRepeatSidebar)
        self.labelRepeatTitle.setStyleSheet("font-size: 20px; font-weight: 700;")
        self.labelRepeatTitle.setObjectName("labelRepeatTitle")
        self.verticalLayoutRepeatSidebar.addWidget(self.labelRepeatTitle)
        self.labelRepeatHint = QtWidgets.QLabel(parent=self.frameRepeatSidebar)
        self.labelRepeatHint.setWordWrap(True)
        self.labelRepeatHint.setStyleSheet("font-size: 13px; color: rgba(226, 232, 240, 0.78);")
        self.labelRepeatHint.setObjectName("labelRepeatHint")
        self.verticalLayoutRepeatSidebar.addWidget(self.labelRepeatHint)
        self.labelReplayFolderPath = QtWidgets.QLabel(parent=self.frameRepeatSidebar)
        self.labelReplayFolderPath.setWordWrap(True)
        self.labelReplayFolderPath.setStyleSheet("font-size: 12px; color: rgba(226, 232, 240, 0.62);")
        self.labelReplayFolderPath.setObjectName("labelReplayFolderPath")
        self.verticalLayoutRepeatSidebar.addWidget(self.labelReplayFolderPath)
        self.btnChooseReplayFolder = QtWidgets.QPushButton(parent=self.frameRepeatSidebar)
        self.btnChooseReplayFolder.setObjectName("btnChooseReplayFolder")
        self.verticalLayoutRepeatSidebar.addWidget(self.btnChooseReplayFolder)
        self.listWidgetReplaySignals = QtWidgets.QListWidget(parent=self.frameRepeatSidebar)
        self.listWidgetReplaySignals.setObjectName("listWidgetReplaySignals")
        self.verticalLayoutRepeatSidebar.addWidget(self.listWidgetReplaySignals)
        self.btnOpenSignalForReplay = QtWidgets.QPushButton(parent=self.frameRepeatSidebar)
        self.btnOpenSignalForReplay.setObjectName("btnOpenSignalForReplay")
        self.verticalLayoutRepeatSidebar.addWidget(self.btnOpenSignalForReplay)
        self.stackedWidgetRepeat = QtWidgets.QStackedWidget(parent=self.splitterRepeat)
        self.stackedWidgetRepeat.setObjectName("stackedWidgetRepeat")
        self.pageRepeatPlaceholder = QtWidgets.QWidget()
        self.pageRepeatPlaceholder.setObjectName("pageRepeatPlaceholder")
        self.verticalLayoutRepeatPlaceholder = QtWidgets.QVBoxLayout(self.pageRepeatPlaceholder)
        self.verticalLayoutRepeatPlaceholder.setObjectName("verticalLayoutRepeatPlaceholder")
        self.labelRepeatPlaceholder = QtWidgets.QLabel(parent=self.pageRepeatPlaceholder)
        self.labelRepeatPlaceholder.setStyleSheet("font-size: 24px; font-weight: 600; color: rgba(226, 232, 240, 0.78);")
        self.labelRepeatPlaceholder.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.labelRepeatPlaceholder.setWordWrap(True)
        self.labelRepeatPlaceholder.setObjectName("labelRepeatPlaceholder")
        self.verticalLayoutRepeatPlaceholder.addWidget(self.labelRepeatPlaceholder)
        self.stackedWidgetRepeat.addWidget(self.pageRepeatPlaceholder)
        self.pageRepeatHost = QtWidgets.QWidget()
        self.pageRepeatHost.setObjectName("pageRepeatHost")
        self.verticalLayoutRepeatHost = QtWidgets.QVBoxLayout(self.pageRepeatHost)
        self.verticalLayoutRepeatHost.setContentsMargins(0, 0, 0, 0)
        self.verticalLayoutRepeatHost.setObjectName("verticalLayoutRepeatHost")
        self.repeatContainer = QtWidgets.QWidget(parent=self.pageRepeatHost)
        self.repeatContainer.setObjectName("repeatContainer")
        self.verticalLayoutRepeatHost.addWidget(self.repeatContainer)
        self.stackedWidgetRepeat.addWidget(self.pageRepeatHost)
        self.verticalLayout_repeat.addWidget(self.splitterRepeat)
        self.tabWidget.addTab(self.tab_repeat, "")
        ...
        self.labelNonProjectMode.setStyleSheet("background: rgba(230, 168, 72, 36); border: 1px solid rgba(230, 168, 72, 120); border-radius: 4px;")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/spectrum.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionSpectrum_Analyzer.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/sniffer.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionSniff_protocol.setIcon(icon2)
        ...
        self.actionExit_App.setIcon(icon)
        ...
        self.stackedWidgetRepeat.setCurrentIndex(0)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "PlutoSDR Protocol Tool - Никита Гурачевский ИА-232"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_interpretation), _translate("MainWindow", "Сигналы"))
        self.labelWaterfallHint.setText(_translate("MainWindow", "Первая вкладка сразу показывает спектр и водопад PlutoSDR. Кнопка запуска находится прямо внутри этой панели."))
        self.btnRecordFromWaterfall.setText(_translate("MainWindow", "Записать сигнал"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_waterfall), _translate("MainWindow", "Водопад"))
        self.labelRepeatTitle.setText(_translate("MainWindow", "Повтор сигнала"))
        self.labelRepeatHint.setText(_translate("MainWindow", "Выбери сигнал из списка. Справа откроется стандартная панель повтора для PlutoSDR."))
        self.labelReplayFolderPath.setText(_translate("MainWindow", "Папка сигналов: не выбрана"))
        self.btnChooseReplayFolder.setText(_translate("MainWindow", "Выбрать папку с сигналами"))
        self.btnOpenSignalForReplay.setText(_translate("MainWindow", "Выбрать файл сигнала"))
        self.labelRepeatPlaceholder.setText(_translate("MainWindow", "Выбери сигнал слева, чтобы открыть окно повтора."))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_repeat), _translate("MainWindow", "Повтор"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_protocol), _translate("MainWindow", "Analysis"))
        self.labelNonProjectMode.setText(_translate("MainWindow", "<html><head/><body><p>Warning: project mode is disabled. Runtime settings may be lost after closing the program. To keep settings, create a project via File -&gt; <a href=\"open_new_project_dialog\"><span style=\" text-decoration: underline;\">New Project</span></a>. <a href=\"dont_show_non_project_again\"><span style=\" text-decoration: underline;\">Don\'t show this hint</span></a></p></body></html>"))
        ...
        self.actionAbout_AutomaticHacker.setText(_translate("MainWindow", "&About PlutoSDR Protocol Tool..."))
        ...
        self.actionExit_App.setText(_translate("MainWindow", "Exit PlutoSDR Protocol Tool"))
