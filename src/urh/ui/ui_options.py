...
class Ui_DialogOptions(object):
    def setupUi(self, DialogOptions):
        ...
        self.tabWidget = QtWidgets.QTabWidget(parent=DialogOptions)
        ...
        self.groupBoxModulationAccuracy = QtWidgets.QGroupBox(parent=self.tabGeneration)
        ...
        self.radioButtonLowModulationAccuracy = QtWidgets.QRadioButton(parent=self.groupBoxModulationAccuracy)
        ...
        self.radioButtonMediumModulationAccuracy = QtWidgets.QRadioButton(parent=self.groupBoxModulationAccuracy)
        ...
        self.radioButtonHighModulationAccuracy = QtWidgets.QRadioButton(parent=self.groupBoxModulationAccuracy)
        ...
        self.label_7 = QtWidgets.QLabel(parent=self.tabView)
        self.label_7.setObjectName("label_7")
        self.horizontalLayout_2.addWidget(self.label_7)
        self.comboBoxDefaultView = QtWidgets.QComboBox(parent=self.tabView)
        ...
        self.checkBoxShowConfirmCloseDialog = QtWidgets.QCheckBox(parent=self.tabView)
        ...
        self.checkBoxHoldShiftToDrag = QtWidgets.QCheckBox(parent=self.tabView)
        ...
        self.checkBoxPauseTime = QtWidgets.QCheckBox(parent=self.tabView)
        self.checkBoxPauseTime.setObjectName("checkBoxPauseTime")
        self.verticalLayout.addWidget(self.checkBoxPauseTime)
        self.checkBoxAlignLabels = QtWidgets.QCheckBox(parent=self.tabView)
        ...
        self.labelFontSize = QtWidgets.QLabel(parent=self.tabView)
        self.labelFontSize.setObjectName("labelFontSize")
        self.horizontalLayout.addWidget(self.labelFontSize)
        self.doubleSpinBoxFontSize = QtWidgets.QDoubleSpinBox(parent=self.tabView)
        ...
        self.label_9 = QtWidgets.QLabel(parent=self.tabView)
        self.label_9.setObjectName("label_9")
        self.horizontalLayout_4.addWidget(self.label_9)
        self.comboBoxTheme = QtWidgets.QComboBox(parent=self.tabView)
        ...
        self.labelIconTheme = QtWidgets.QLabel(parent=self.tabView)
        self.labelIconTheme.setObjectName("labelIconTheme")
        self.horizontalLayout_5.addWidget(self.labelIconTheme)
        self.comboBoxIconTheme = QtWidgets.QComboBox(parent=self.tabView)
        ...
        self.groupBoxSpectrogramColormap = QtWidgets.QGroupBox(parent=self.tabView)
        ...
        self.scrollAreaSpectrogramColormap = QtWidgets.QScrollArea(parent=self.groupBoxSpectrogramColormap)
        ...
        self.tblLabeltypes = QtWidgets.QTableView(parent=self.tabFieldtypes)
        ...
        self.btnAddLabelType = QtWidgets.QToolButton(parent=self.tabFieldtypes)
        ...
        self.btnRemoveLabeltype = QtWidgets.QToolButton(parent=self.tabFieldtypes)
        ...
        spacerItem2 = QtWidgets.QSpacerItem(20, 203, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        self.labelInfoDeviceTable = QtWidgets.QLabel(parent=self.tabDevices)
        font = QtGui.QFont()
        font.setItalic(True)
        ...
        self.tblDevices = QtWidgets.QTableView(parent=self.tabDevices)
        ...
        self.labelDeviceMissingInfo = QtWidgets.QLabel(parent=self.tabDevices)
        font = QtGui.QFont()
        ...
        self.line = QtWidgets.QFrame(parent=self.tabDevices)
        self.line.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line.setObjectName("line")
        self.verticalLayout_8.addWidget(self.line)
        self.groupBoxNativeOptions = QtWidgets.QGroupBox(parent=self.tabDevices)
        ...
        self.labelLibDirs = QtWidgets.QLabel(parent=self.groupBoxNativeOptions)
        self.labelLibDirs.setObjectName("labelLibDirs")
        self.gridLayout_5.addWidget(self.labelLibDirs, 2, 0, 1, 1)
        self.lineEditIncludeDirs = QtWidgets.QLineEdit(parent=self.groupBoxNativeOptions)
        self.lineEditIncludeDirs.setObjectName("lineEditIncludeDirs")
        self.gridLayout_5.addWidget(self.lineEditIncludeDirs, 3, 2, 1, 1)
        self.labelNativeRebuildInfo = QtWidgets.QLabel(parent=self.groupBoxNativeOptions)
        ...
        self.lineEditLibDirs = QtWidgets.QLineEdit(parent=self.groupBoxNativeOptions)
        self.lineEditLibDirs.setObjectName("lineEditLibDirs")
        self.gridLayout_5.addWidget(self.lineEditLibDirs, 2, 2, 1, 1)
        self.labelIncludeDirs = QtWidgets.QLabel(parent=self.groupBoxNativeOptions)
        self.labelIncludeDirs.setObjectName("labelIncludeDirs")
        self.gridLayout_5.addWidget(self.labelIncludeDirs, 3, 0, 1, 1)
        self.btnViewBuildLog = QtWidgets.QPushButton(parent=self.groupBoxNativeOptions)
        ...
        self.btnRebuildNative = QtWidgets.QPushButton(parent=self.groupBoxNativeOptions)
        ...
        self.labelRebuildNativeStatus = QtWidgets.QLabel(parent=self.groupBoxNativeOptions)
        self.labelRebuildNativeStatus.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.line_2 = QtWidgets.QFrame(parent=self.tabDevices)
        self.line_2.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_2.setObjectName("line_2")
        self.verticalLayout_8.addWidget(self.line_2)
        self.groupBox_3 = QtWidgets.QGroupBox(parent=self.tabDevices)
        ...
        self.lineEditGRPythonInterpreter = QtWidgets.QLineEdit(parent=self.groupBox_3)
        ...
        self.btnChooseGRPythonInterpreter = QtWidgets.QToolButton(parent=self.groupBox_3)
        ...
        self.line_3 = QtWidgets.QFrame(parent=self.tabDevices)
        ...
        self.label_8 = QtWidgets.QLabel(parent=self.tabDevices)
        self.label_8.setObjectName("label_8")
        self.gridLayout_3.addWidget(self.label_8, 0, 0, 1, 1)
        self.spinBoxNumSendingRepeats = QtWidgets.QSpinBox(parent=self.tabDevices)
        ...
        self.label_5 = QtWidgets.QLabel(parent=self.tabDevices)
        self.label_5.setObjectName("label_5")
        self.gridLayout_3.addWidget(self.label_5, 1, 0, 1, 1)
        self.doubleSpinBoxRAMThreshold = QtWidgets.QDoubleSpinBox(parent=self.tabDevices)
    ...
    def retranslateUi(self, DialogOptions):
        ...
        self.radioButtonLowModulationAccuracy.setText(_translate("DialogOptions", "Low (2x8 bit)"))
        self.radioButtonMediumModulationAccuracy.setText(_translate("DialogOptions", "Medium (2x16 bit) - Recommended for PlutoSDR"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabGeneration), _translate("DialogOptions", "Replay"))
        ...
        self.comboBoxTheme.setItemText(0, _translate("DialogOptions", "native look"))
        self.comboBoxTheme.setItemText(1, _translate("DialogOptions", "sandstone light"))
        self.comboBoxTheme.setItemText(2, _translate("DialogOptions", "copper night"))
        ...
        self.labelDeviceMissingInfo.setText(_translate("DialogOptions", "Only the native PlutoSDR backend is used in this build. If PlutoSDR is missing, rebuild the native extension."))
        ...
        self.btnRebuildNative.setToolTip(_translate("DialogOptions", "<html><head/><body><p>Rebuild the native PlutoSDR extension. Restart the app after rebuilding.</p></body></html>"))
        self.btnRebuildNative.setText(_translate("DialogOptions", "Rebuild"))
        self.labelRebuildNativeStatus.setText(_translate("DialogOptions", "Rebuild <x> native PlutoSDR extensions. Restart the app to use them."))
        self.groupBox_3.setTitle(_translate("DialogOptions", "Disabled legacy backend options"))
        self.label.setToolTip(_translate("DialogOptions", "This PlutoSDR-only build does not use external backend interpreters."))
        self.label.setText(_translate("DialogOptions", "Interpreter:"))
        self.lineEditGRPythonInterpreter.setToolTip(_translate("DialogOptions", "This PlutoSDR-only build does not use external backend interpreters."))
        self.lineEditGRPythonInterpreter.setPlaceholderText(_translate("DialogOptions", "Disabled in PlutoSDR-only mode"))
