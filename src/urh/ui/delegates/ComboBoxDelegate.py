...
class ComboBoxDelegate(QStyledItemDelegate):
    ...
    def paint(
        ...
        if self.colors:
            try:
                ...
                frame_color = palette.color(QPalette.ColorRole.Mid)
                ...
                painter.fillRect(rect, frame_color)
    ...
    def createEditor(
        ...
        if self.colors:
            ...
            painter.fillRect(img.rect(), frame_color)
            ...
            for i, item in enumerate(self.items):
                ...
                editor.setItemData(
                    i, QPixmap.fromImage(img), Qt.ItemDataRole.DecorationRole
                )
