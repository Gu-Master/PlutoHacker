...
class Ui_SignalFrame(object):
    def setupUi(self, SignalFrame):
        ...
        SignalFrame.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        SignalFrame.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        ...
        self.spinBoxBitsPerSymbol = QtWidgets.QSpinBox(parent=SignalFrame)
        ...
        self.btnSaveSignal = QtWidgets.QToolButton(parent=SignalFrame)
        ...
        self.btnCloseSignal.setStyleSheet("")
        ...
        self.btnInfo = QtWidgets.QToolButton(parent=SignalFrame)
        ...
        self.btnReplay = QtWidgets.QToolButton(parent=SignalFrame)
        ...
        self.labelModulation = QtWidgets.QLabel(parent=SignalFrame)
        ...
        self.spinBoxNoiseTreshold = QtWidgets.QDoubleSpinBox(parent=SignalFrame)
        ...
        self.spinBoxCenterSpacing = QtWidgets.QDoubleSpinBox(parent=SignalFrame)
        ...
        self.lineEditSignalName.setMinimumSize(QtCore.QSize(160, 0))
        ...
        self.cbModulationType = QtWidgets.QComboBox(parent=SignalFrame)
        ...
        self.btnAdvancedModulationSettings = QtWidgets.QToolButton(parent=SignalFrame)
        ...
        self.line = QtWidgets.QFrame(parent=SignalFrame)
        ...
        self.sliderSpectrogramMin.setOrientation(QtCore.Qt.Orientation.Horizontal)
        ...
        self.labelFFTWindowSize = QtWidgets.QLabel(parent=SignalFrame)
        ...
        self.sliderSpectrogramMax.setOrientation(QtCore.Qt.Orientation.Horizontal)
        ...
        self.spinBoxCenterOffset = QtWidgets.QDoubleSpinBox(parent=SignalFrame)
        ...
        self.sliderFFTWindowSize.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.sliderFFTWindowSize.setObjectName("sliderFFTWindowSize")
        self.gridLayout_2.addWidget(self.sliderFFTWindowSize, 20, 1, 1, 1)
        self.lBitsPerSymbol = QtWidgets.QLabel(parent=SignalFrame)
...
"}")
        ...
        self.gvSpectrogram = SpectrogramGraphicView(parent=self.pageSpectrogram)
        ...
        self.labelLoadingAutoInterpretation = QtWidgets.QLabel(parent=self.pageLoading)
        font = QtGui.QFont()
        ...
        self.sliderYScale.setOrientation(QtCore.Qt.Orientation.Vertical)
        self.sliderYScale.setTickPosition(QtWidgets.QSlider.TickPosition.TicksBelow)
        ...
        self.lNumSelectedSamples = QtWidgets.QLabel(parent=self.layoutWidget)
        self.lNumSelectedSamples.setObjectName("lNumSelectedSamples")
        self.horizontalLayout_3.addWidget(self.lNumSelectedSamples)
        self.lTextSelectedSamples = QtWidgets.QLabel(parent=self.layoutWidget)
        ...
        self.lDuration = QtWidgets.QLabel(parent=self.layoutWidget)
        ...
        self.lStart = QtWidgets.QLabel(parent=self.layoutWidget)
        self.lStart.setObjectName("lStart")
        self.additionalInfos.addWidget(self.lStart)
        self.spinBoxSelectionStart = QtWidgets.QSpinBox(parent=self.layoutWidget)
        ...
        self.lEnd = QtWidgets.QLabel(parent=self.layoutWidget)
        self.lEnd.setObjectName("lEnd")
        self.additionalInfos.addWidget(self.lEnd)
        self.spinBoxSelectionEnd = QtWidgets.QSpinBox(parent=self.layoutWidget)
        ...
        self.lStrich = QtWidgets.QLabel(parent=self.layoutWidget)
        self.lStrich.setObjectName("lStrich")
        self.additionalInfos.addWidget(self.lStrich)
        self.lSamplesTotal = QtWidgets.QLabel(parent=self.layoutWidget)
        self.lSamplesTotal.setObjectName("lSamplesTotal")
        self.additionalInfos.addWidget(self.lSamplesTotal)
        self.lSamplesViewText = QtWidgets.QLabel(parent=self.layoutWidget)
    ...
    def retranslateUi(self, SignalFrame):
        ...
        self.btnReplay.setToolTip(_translate("SignalFrame", "Повторить сигнал"))
...
"If you want your protocol to be better separated, edit the PauseLen using right-click menu from a selection in SignalView or ProtocolView."))
        ...
        self.btnAutoDetect.setText(_translate("SignalFrame", "Автоподбор параметров"))
        ...
        self.btnFilter.setText(_translate("SignalFrame", "Фильтр"))
