...
class Ui_SendRecvDialog(object):
    def setupUi(self, SendRecvDialog):
        ...
        SendRecvDialog.setWindowModality(QtCore.Qt.WindowModality.NonModal)
...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 658, 1111))
...
"}")
        ...
        self.progressBarMessage = QtWidgets.QProgressBar(parent=self.groupBox)
        ...
        self.labelCurrentMessage = QtWidgets.QLabel(parent=self.groupBox)
        self.labelCurrentMessage.setObjectName("labelCurrentMessage")
        self.gridLayout_2.addWidget(self.labelCurrentMessage, 18, 0, 1, 1)
        self.lReceiveBufferFullText = QtWidgets.QLabel(parent=self.groupBox)
        ...
        self.progressBarSample = QtWidgets.QProgressBar(parent=self.groupBox)
        ...
        self.lSamplesSentText = QtWidgets.QLabel(parent=self.groupBox)
        self.lSamplesSentText.setObjectName("lSamplesSentText")
        self.gridLayout_2.addWidget(self.lSamplesSentText, 20, 0, 1, 1)
        self.lTimeText = QtWidgets.QLabel(parent=self.groupBox)
        ...
        self.lSamplesCaptured.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lSamplesCaptured.setObjectName("lSamplesCaptured")
        self.gridLayout_2.addWidget(self.lSamplesCaptured, 6, 0, 1, 2)
        self.lTime = QtWidgets.QLabel(parent=self.groupBox)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.lTime.setFont(font)
        self.lTime.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.lSignalSize.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lSignalSize.setObjectName("lSignalSize")
        self.gridLayout_2.addWidget(self.lSignalSize, 11, 0, 1, 2)
        self.lblRepeatText = QtWidgets.QLabel(parent=self.groupBox)
        self.lblRepeatText.setObjectName("lblRepeatText")
        self.gridLayout_2.addWidget(self.lblRepeatText, 16, 0, 1, 1)
        self.lblCurrentRepeatValue = QtWidgets.QLabel(parent=self.groupBox)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.lblCurrentRepeatValue.setFont(font)
        self.lblCurrentRepeatValue.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.labelReceiveBufferFull.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.graphicsView_sniff_Preview = LiveGraphicView(parent=self.page_sniff)
        ...
        self.btnAccept = QtWidgets.QPushButton(parent=self.page_sniff)
        ...
        self.label_y_scale = QtWidgets.QLabel(parent=self.layoutWidget)
    ...
    def retranslateUi(self, SendRecvDialog):
        ...
        SendRecvDialog.setWindowTitle(_translate("SendRecvDialog", "Запись сигнала"))
        ...
        self.btnStart.setToolTip(_translate("SendRecvDialog", "Запуск"))
        self.btnStart.setText(_translate("SendRecvDialog", "Старт"))
        self.btnStop.setToolTip(_translate("SendRecvDialog", "Остановить"))
        self.btnStop.setText(_translate("SendRecvDialog", "Стоп"))
        self.btnSave.setText(_translate("SendRecvDialog", "Сохранить..."))
        self.btnClear.setToolTip(_translate("SendRecvDialog", "Очистить"))
        self.btnClear.setText(_translate("SendRecvDialog", "Очистить"))
