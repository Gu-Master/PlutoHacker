...
class SignalFrame(QFrame):
        ...
        if self.signal is not None:
            ...
            if self.signal.wav_mode:
                if self.signal.already_demodulated:
                    self.ui.lSignalTyp.setText("Демодулированный (1-канальный *.wav)")
                else:
                    self.ui.lSignalTyp.setText("Сигнал (*.wav)")
            else:
                self.ui.lSignalTyp.setText("Комплексный сигнал")
            ...
            self.ui.cbProtoView.setCurrentIndex(1)
            self.ui.chkBoxShowProtocol.setChecked(False)
            ...
            self.ui.lSignalTyp.setText("Протокол")
    ...
    def __localize_ui(self):
        self.ui.lSignalViewText.setText(self.tr("Вид сигнала:"))
        self.ui.cbSignalView.setItemText(0, self.tr("Аналоговый"))
        self.ui.cbSignalView.setItemText(1, self.tr("Демодулированный"))
        self.ui.cbSignalView.setItemText(2, self.tr("Спектрограмма"))
        self.ui.cbSignalView.setItemText(3, self.tr("I/Q вид"))
        self.ui.cbProtoView.setItemText(0, self.tr("Биты"))
        self.ui.cbProtoView.setItemText(1, self.tr("Hex"))
        self.ui.cbProtoView.setItemText(2, self.tr("ASCII"))
        self.ui.chkBoxShowProtocol.setText(self.tr("Показать данные"))
        self.ui.labelNoise.setText(self.tr("Шум:"))
        self.ui.lCenterOffset.setText(self.tr("Центр:"))
        self.ui.lCenterSpacing.setText(self.tr("Шаг центра:"))
        self.ui.lSamplesPerSymbol.setText(self.tr("Сэмплов на символ:"))
        self.ui.lErrorTolerance.setText(self.tr("Допуск ошибки:"))
        self.ui.labelModulation.setText(self.tr("Модуляция:"))
        self.ui.lBitsPerSymbol.setText(self.tr("Бит на символ:"))
        self.ui.labelFFTWindowSize.setText(self.tr("Размер FFT:"))
        self.ui.labelSpectrogramMin.setText(self.tr("Мин. уровень:"))
        self.ui.labelSpectrogramMax.setText(self.tr("Макс. уровень:"))
        self.ui.btnReplay.setToolTip(self.tr("Повторить сигнал"))
        self.ui.btnInfo.setToolTip(self.tr("Сведения о сигнале"))
        self.ui.btnCloseSignal.setToolTip(self.tr("Закрыть сигнал"))
    ...
    def set_filter_button_caption(self):
        self.ui.btnFilter.setText(
            "Фильтр ({0})".format(self.dsp_filter.filter_type.value)
        )
